...
<c:if test="${stu.active==true}">
<td bgcolor="green">ACTIVE</td>
</c:if>
<c:if test="${stu.active==false}">
<td bgcolor="red">INACTIVE</td>
</c:if>

<td>
<a href='<c:url value="settstatus?id=${stu.id}&status=true"></c:url>' class="status-button active">
                <i class="fas fa-check-circle"></i> Active
            </a>
            <!-- Button for setting status to Inactive -->
<a href='<c:url value="settstatus?id=${stu.id}&status=false"></c:url>' class="status-button inactive">
